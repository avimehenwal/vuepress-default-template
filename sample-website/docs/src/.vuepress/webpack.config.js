...
module.exports = {
  ...
  configureWebpack: {
    ...
    resolve: {
      /**
       * FIXME Module not found: Error: Can't resolve'@assets/face.png' in
       * '/home/avi/GIT/vuepress-default-theme-template/sample-website/docs/src/posts'
       *
       * Module not found: Error: Can't resolve '@assets/face.png' in '/home/avi/GIT/vuepress-default-theme-template/sample-website/docs/src/posts'
       *
